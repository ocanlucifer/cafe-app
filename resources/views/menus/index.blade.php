...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <button class="btn btn-primary btn-sm" id="open-create-form">
            <i class="bi bi-plus-lg" style="font-size: 1rem;"></i> Add Menu
        </button>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="menuModalLabel">Menu Form</h5>
                ...
                <div class="modal-body">
                    <form id="menu-form">
                        ...
                        <div class="mb-3">
                            <label for="menu-category_id" class="form-label">Category</label>
    ...
    $(document).ready(function() {
        ...
        $('#save-menu').on('click', function() {
            ...
            $.ajax({
                ...
                data: formData,
                success: function() {
                    $('#success-message').removeClass('d-none').text('Menu saved successfully!');
                    setTimeout(() => { $('#success-message').addClass('d-none'); }, 3000);
                    $('#menuModal').modal('hide');
                    fetchMenus();
                },
                error: function() { alert('Error saving menu.'); }
            });
        });
        ...
        $(document).on('click', '.delete-menu', function() {
            if (confirm('Are you sure you want to delete this menu?')) {
                ...
                $.ajax({
                    ...
                    error: function() { alert('Error deleting menu.'); }
                });
            }
        });
        ...
        $(document).on('click', '.toggle-status', function() {
            ...
            $.ajax({
                ...
                data: { _token: $('meta[name="csrf-token"]').attr('content') },
                success: function() { fetchMenus(); },
                error: function() { alert('Error updating menus status.'); }
            });
        });
    });
