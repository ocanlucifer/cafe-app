                ...
                <div class="modal-body">
                    <form id="customer-form">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="tel" class="form-control" id="customer-contact" name="contact" required maxlength="15" pattern="^\d{1,15}$" title="Hanya boleh angka dan maksimal 15 karakter">
                        </div>
                        <div class="mb-3">
